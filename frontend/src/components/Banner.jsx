  ...
  return (
   <>
        ...
        <div className='max-w-screen-2xl flex md:flex-row container md:px-20 mx-auto flex-col px-4'>
            ...
            <div className='div1 '>
                        <h1 className='text-4xl font-bold'>Hello, welcome to {""}<span className="text-red-500">ShopGalaxy</span></h1><br></br>
                        <p className='text-xl '>
                        ...
                        <label className="input input-bordered flex items-center gap-2 mt-8">
                            ...
                            <a href='/'><button className="btn btn-error text-white mt-4">Home</button></a> 
            </div>
            </div>
